...
- (void)updateContent {
    if (_scrollView.contentOffset.x > self.frame.size.width) { //next
    ...
    } else if(_scrollView.contentOffset.x < self.frame.size.width) { //before
...
#pragma mark - delegate for UIScrollViewDelegate
